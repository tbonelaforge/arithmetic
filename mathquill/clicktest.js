...
console.log("Inside the handler generated by onKeyDown, got called with event:\n");
    console.log(event);
    if (event.code == "ArrowRight") {
      ...
      console.log("Realized the delete key was pressed...\n");
...
function onKeyPress(numberEditor) {
  ...
  return function(event) {
    ...
    console.log(event);
    console.log("The event.key is %s:\n", event.key);
...
function handleClickOutside(e) {
  console.log("Inside handleClickOutside, got called with e:");
  console.log(e);
  NodeScanner.setStates(node7);
  if (cursorFlasher != null) {
    clearInterval(cursorFlasher);
